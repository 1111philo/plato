...
plato runs a single **open-weight** model on Amazon Bedrock — [Qwen3-VL 235B
A22B](https://huggingface.co/Qwen/Qwen3-VL-235B-A22B-Instruct) (Apache-2.0). All
nine agents share it; there is no per-agent routing.
