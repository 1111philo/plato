...
export async function sendInviteEmail(toEmail, inviteToken, invitedByName) {
  ...
  const html = `
    <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      <div style="background: #1e1b3a; color: #fff; padding: 16px 20px; border-radius: 8px 8px 0 0; font-weight: 700;">
        plato
      </div>
      <div style="border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 8px 8px; padding: 24px 20px;">
        ...
        <a href="${signupUrl}" style="display: inline-block; background: #1e1b3a; color: #fff; padding: 10px 24px; border-radius: 8px; text-decoration: none; font-weight: 600;">
          Create your account
        </a>
  ...
  const html = `
    <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
      ...
      <div style="border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 8px 8px; padding: 24px 20px;">
        ...
        <a href="${resetUrl}" style="display: inline-block; background: #1e1b3a; color: #fff; padding: 10px 24px; border-radius: 8px; text-decoration: none; font-weight: 600;">
          Reset password
        </a>
        <p style="color: #555; font-size: 13px; line-height: 1.5; margin: 20px 0 0;">
